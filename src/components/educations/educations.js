  ...
  return (
    ...
    <div className="row">
      ...
      <div className="col s12 m4">
        <div className="card school-card">
          <div className="card-image">
            <img className={'school-img'} alt={'polytech paris sud'} src="https://www.embedded-france.org/wp-content/uploads/2019/01/Polytech.jpg"/>
          </div>
          <div className="card-content">
